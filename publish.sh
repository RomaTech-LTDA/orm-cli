...
# ---------------------------------------------------------------------------
# publish.sh — Build verification and npm publish for @romatech/orm-cli
# ---------------------------------------------------------------------------
# Usage:
...
echo "============================================"
echo " @romatech/orm-cli — publish pipeline"
echo "============================================"
echo ""
...
# 7. Publish
echo "[6/6] Publishing @romatech/orm-cli@$NEW_VERSION to npm..."
npm publish --access public
echo ""

echo "============================================"
echo " Published @romatech/orm-cli@$NEW_VERSION"
echo "============================================"
